...
vlive_data <- vlive_data %>% 
  mutate(Month = month(ymd(vlive_data$date_c))) %>% 
  mutate(Year = year(ymd(vlive_data$date_c)))

# Remove influential points and filter data from Jan-April
